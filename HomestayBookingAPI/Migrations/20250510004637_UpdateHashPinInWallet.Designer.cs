...
namespace HomestayBookingAPI.Migrations
{
    ...
    [Migration("20250510004637_UpdateHashPinInWallet")]
    partial class UpdateHashPinInWallet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomestayBookingAPI.Models.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HomestayBookingAPI.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HomestayBookingAPI.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HomestayBookingAPI.Models.CommentImage", b =>
                {
                    b.HasOne("HomestayBookingAPI.Models.Comment", "Comment")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("HomestayBookingAPI.Models.Promotion", b =>
                {
                    b.HasOne("HomestayBookingAPI.Models.Voucher", "Voucher")
                        .WithMany()
            ...
            modelBuilder.Entity("HomestayBookingAPI.Models.Wallet", b =>
                {
                    b.HasOne("HomestayBookingAPI.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("HomestayBookingAPI.Models.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HomestayBookingAPI.Models.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("HomestayBookingAPI.Models.Payment", "Payment")
                        .WithMany()
                        .HasForeignKey("PaymentId");

                    b.HasOne("HomestayBookingAPI.Models.Wallet", "Wallet")
                        .WithMany()
